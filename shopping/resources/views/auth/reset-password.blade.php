<x-guest-layout>
    <section class="mb-4 text-secondary">
        <h2 class="h4 mb-0"><i class="fas fa-key me-2"></i> Reset password</h2>
    </section>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mb-3">
            ...
            <x-text-input id="email" class="form-control form-outline" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
